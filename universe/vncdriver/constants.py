...
ENCODINGS_NAMES_TO_IDS = {
    'RAW_ENCODING': RAW_ENCODING,
    'COPY_RECTANGLE_ENCODING': COPY_RECTANGLE_ENCODING,
    'RRE_ENCODING': RRE_ENCODING,
    'CORRE_ENCODING': CORRE_ENCODING,
    'HEXTILE_ENCODING': HEXTILE_ENCODING,
    'ZLIB_ENCODING': ZLIB_ENCODING,
    'TIGHT_ENCODING': TIGHT_ENCODING,
    'ZLIBHEX_ENCODING': ZLIBHEX_ENCODING,
    'ZRLE_ENCODING': ZRLE_ENCODING,
    'PSEUDO_CURSOR_ENCODING': PSEUDO_CURSOR_ENCODING,
}

ENCODINGS_IDS_TO_NAMES = {v: k for k, v in ENCODINGS_NAMES_TO_IDS.items()}
